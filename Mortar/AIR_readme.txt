Tips for Building with Flash Develop:
* Check Flex SDK dir
* Project >> Output >> Custom: $(FlexSDK)\bin\adl.exe;application.xml bin
...
- run PackageApplication.bat, you will be prompted for the certificate password, (note that you may not see '***' when typing your password - it works anyway)
