...
{
    private static final String TAG = "MASS-JAVA - BillingReceiver";
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        {
        	Log.d("GEO-TEST", "PURCHASED_STATE_CHANGED" ); // test
        ...
        {
        	Log.d("GEO-TEST", "RESPONSE_CODE ("+intent.getIntExtra("response_code", -1)+")" ); // test
        ...
        {
        	Log.d("GEO-TEST", "UNEXPECTED" ); // test
