...
import com.modernalchemists.mass.android.util.Base64;
import com.modernalchemists.mass.android.util.Base64DecoderException;
...
public class Security {
    private static final String TAG = "MASS_JAVA - Security";
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = Config.getInstance().base64EncodedPublicKey;
