...
import com.modernalchemists.mass.android.Security.VerifiedPurchase;
...
{
    private static final String TAG = "MASS-JAVA - BillingService";
    ...
    public void handleCommand(Intent intent, int startId) {
    	if(intent == null)
    	{
    		Log.e(TAG, "ERROR - handleCommand intent is null!");
    		return;
    	}
    ...
    private void purchaseStateChanged(int startId, String signedData, String signature)
    {
        ...
        Store.getInstance().setReceivedData(signedData);
