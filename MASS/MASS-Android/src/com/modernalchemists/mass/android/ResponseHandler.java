...
public class ResponseHandler {
    private static final String TAG = "MASS-JAVA - ResponseHandler";

    /**
     * This is a static instance of {@link MassPurchaseObserver} that the
     * application creates and registers with this class. The PurchaseObserver
     * is used for updating the UI if the UI is visible.
     */
    private static MassPurchaseObserver sPurchaseObserver;

    /**
     * Registers an observer that updates the UI.
     * @param observer the observer to register
     */
    public static synchronized void register(MassPurchaseObserver observer)
    {
     ...
     */
    public static synchronized void unregister(MassPurchaseObserver observer)
    {
    ...
    public static void buyPageIntentResponse(PendingIntent pendingIntent, Intent intent) {
    	Log.d("MASS TEST", "buyPageIntentResponse - Observer:" + sPurchaseObserver);
        if (sPurchaseObserver == null) {
            if (Consts.DEBUG) {
